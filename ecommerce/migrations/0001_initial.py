    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('supplier', 'Supplier'), ('buyer', 'Buyer'), ('staff', 'Staff')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Order received'), ('processing', 'Order is being processed'), ('shipped', 'Order has been shipped'), ('delivered', 'Order is delivered'), ('cancelled', 'Order is cancelled')], default='new', max_length=50)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='ecommerce.Contact')),
        ...
        migrations.AddField(
            model_name='cart',
            name='contact',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='ecommerce.Contact'),
        ),
        migrations.AddField(
            model_name='cart',
            name='user',
